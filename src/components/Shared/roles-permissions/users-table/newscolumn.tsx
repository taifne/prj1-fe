...
import { News, STATUSES, type User } from '@/data/users-data';
...
export const getColumns = ({
  ...
  {
    title: <HeaderCell title="Create by" />,
    dataIndex: 'permissions',
    key: 'permissions',
    width: 200,
    render: (permissions:News) => (
      <div className="flex items-center gap-2">
       {permissions?.createdBy?.fullName??"hihi"}
      </div>
    ),
  },
  {
