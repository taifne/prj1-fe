...
import FormPart from '@/components/Shared/multi-step/form-part';
import BasicInfo, {
  BasicInfoSchema,
  basicInfoValues,
} from '@/components/Shared/multi-step/basic-info';
import UploadPhoto from '@/components/Shared/multi-step/upload-photo';
import AccommodationInfo, {
  AccommodationSchema,
  accommodationValues,
} from '@/components/Shared/multi-step/accommodation-info';
import { useStepperOne } from '@/components/Shared/multi-step/multi-step-1';
