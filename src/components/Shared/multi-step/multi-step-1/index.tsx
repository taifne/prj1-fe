...
import StepOne from '@/components/Shared/multi-step/multi-step-1/step-1';
import StepTwo from '@/components/Shared/multi-step/multi-step-1/step-2';
import StepThree from '@/components/Shared/multi-step/multi-step-1/step-3';
import StepFour from '@/components/Shared/multi-step/multi-step-1/step-4';
import StepFive from '@/components/Shared/multi-step/multi-step-1/step-5';
import StepSix from '@/components/Shared/multi-step/multi-step-1/step-6';
import StepSeven from '@/components/Shared/multi-step/multi-step-1/step-7';
import Congratulations from '@/components/Shared/multi-step/multi-step-1/congratulations';
