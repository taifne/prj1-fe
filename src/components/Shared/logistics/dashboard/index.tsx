...
import AvgDeliveryTime from '@/components/Shared/logistics/dashboard/avg-delivery-time';
import ComplaintRate from '@/components/Shared/logistics/dashboard/complaint-rate';
import ComplaintReason from '@/components/Shared/logistics/dashboard/complaint-reason';
import { DeliveryStatus } from '@/components/Shared/logistics/dashboard/delivery-status';
import DispatchPlanning from '@/components/Shared/logistics/dashboard/dispatch-planning';
import FleetStatus from '@/components/Shared/logistics/dashboard/fleet-status';
import LoadingWorkflow from '@/components/Shared/logistics/dashboard/loading-workflow';
import OpenSalesOrder from '@/components/Shared/logistics/dashboard/open-sales-order';
import ProfitChart from '@/components/Shared/logistics/dashboard/profit';
import StatCards from '@/components/Shared/logistics/dashboard/stat-cards';
import TopCustomer from '@/components/Shared/logistics/dashboard/top-customer';
import TopShipmentCountries from '@/components/Shared/logistics/dashboard/top-shipment-countries';
import ShipmentTableWidget from '@/components/Shared/logistics/dashboard/shipment-table';
