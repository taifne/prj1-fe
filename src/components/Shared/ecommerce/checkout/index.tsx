...
import DifferentBillingAddress from '@/components/Shared/ecommerce/order/order-form/different-billing-address';
import { orderData } from '@/components/Shared/ecommerce/order/order-form/form-utils';
import AddressInfo from '@/components/Shared/ecommerce/order/order-form/address-info';
import ShippingMethod from '@/components/Shared/ecommerce/checkout/shipping-method';
import PaymentMethod from '@/components/Shared/ecommerce/checkout/payment-method';
import OrderSummery from '@/components/Shared/ecommerce/checkout/order-summery';
import OrderNote from '@/components/Shared/ecommerce/checkout/order-note';
