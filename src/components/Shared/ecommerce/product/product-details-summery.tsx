...
import GetSize from '@/components/Shared/ecommerce/product/get-size';
import { calculatePercentage } from '@/utils/calculate-percentage';
import { GetColor } from '@/components/Shared/ecommerce/product/get-color';
import WishlistButton from '@/components/Shared/ecommerce/product/wishlist-button';
