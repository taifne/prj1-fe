...
import StatCards from '@/components/Shared/ecommerce/dashboard/stat-cards';
import ProfitWidget from '@/components/Shared/ecommerce/dashboard/profit-widget';
import SalesReport from '@/components/Shared/ecommerce/dashboard/sales-report';
import BestSellers from '@/components/Shared/ecommerce/dashboard/best-sellers';
import RepeatCustomerRate from '@/components/Shared/ecommerce/dashboard/repeat-customer-rate';
import UserLocation from '@/components/Shared/ecommerce/dashboard/user-location';
import PromotionalSales from '@/components/Shared/ecommerce/dashboard/promotional-sales';
import RecentOrder from '@/components/Shared/ecommerce/dashboard/recent-order';
import StockReport from '@/components/Shared/ecommerce/dashboard/stock-report';
