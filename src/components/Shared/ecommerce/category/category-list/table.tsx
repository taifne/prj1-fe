...
import { getColumns } from '@/components/Shared/ecommerce/category/category-list/columns';
// dynamic import
const TableFooter = dynamic(
  () => import('@/components/Shared/ecommerce/category/category-list/table-footer'),
  { ssr: false }
);
