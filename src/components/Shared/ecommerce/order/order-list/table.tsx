...
import { getColumns } from '@/components/Shared/ecommerce/order/order-list/columns';
import { ActionIcon } from '@/components/ui/action-icon';
import ExpandedOrderRow from '@/components/Shared/ecommerce/order/order-list/expanded-row';
import cn from '@/utils/class-names';
// dynamic import
const FilterElement = dynamic(
  () => import('@/components/Shared/ecommerce/order/order-list/filter-element'),
  { ssr: false }
);
