...
const classes = {
  base: {
    item: "[&>.rc-pagination-item>a]:text-gray-500 [&>.rc-pagination-item>a]:font-medium [&>li.rc-pagination-item]:border-gray-300  [&>.rc-pagination-item>a]:focus:text-gray-700 [&>.rc-pagination-item:not(.rc-pagination-item-active)]:bg-transparent",
  ...
  variant: {
    solid: {
      base: "[&>.rc-pagination-item-active>a]:!text-black-500 [&>.rc-pagination-item-active>a]:hover:text-black-500",
      color: {
        DEFAULT:
